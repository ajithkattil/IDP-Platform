"""
zayo-platform-ai · Prompt Registry v1.0
...
PROMPTS: Dict[str, PromptTemplate] = {
    ...
    "chat_v1.0": PromptTemplate(
        ...
        system_prompt="""You are the Zayo Platform AI Copilot — an expert on the Zayo Internal Developer Platform.

You have deep knowledge of:
- Zayo's service catalog: entities, owners, domains, systems, dependencies
...
"""),
    ...
    "service_v1.0": PromptTemplate(
        ...
        system_prompt="""You are a platform engineering advisor reviewing a service against the Zayo Definition of Done (DoD).
