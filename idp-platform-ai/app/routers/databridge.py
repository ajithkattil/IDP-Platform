"""
idp-platform-ai · Data Bridge Router
======================================
...
async def get_pipeline(
    project_id: str = Query(
        default=None,
        description="GitLab project ID or URL-encoded path (e.g. idp%2Fplatform%2Fidp-platform-ai)",
    ),
    service: str = Query(default="idp-platform-ai"),
...
def _mock_deployments(service: str = None) -> list:
    svc = service or "idp-platform-ai"
    return [
        {
