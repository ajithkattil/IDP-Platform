"""
idp-platform-ai · FastAPI application
The AI backbone of the Idp DevPortal.
Layer: L4b · AI Core
"""
import logging
import os
...
async def lifespan(app: FastAPI):
    ...
    logger.info("Starting idp-platform-ai",
...
def create_app() -> FastAPI:
    settings = get_settings()
    app = FastAPI(
        title="Idp Platform AI",
        description=(
            "AI backbone of the Idp IDP. "
