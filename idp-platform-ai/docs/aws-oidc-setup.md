...
GITLAB_GROUP="idp/platform"   # your GitLab group path
...
aws iam create-role \
  --role-name "idp-poc-gitlab-ci-role" \
...
| `AWS_ROLE_ARN` | `arn:aws:iam::123456789012:role/idp-poc-gitlab-ci-role` | ✓ | ✗ |
...
```
[auth] arn:aws:sts::123456789012:assumed-role/idp-poc-gitlab-ci-role/gitlab-ci-...
```
