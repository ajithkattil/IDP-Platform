 ...
 *      → zayo-platform-ai explains it in plain English
 *
 *   2. CWE-89: SQL injection in getOrderById()
 *      → caught by Checkmarx SAST
 *      → zayo-platform-ai explains it and provides fix
 *
 * In the POC demo:
...
public class OrderController {
    ...
    private final List<Map<String, Object>> orders = new ArrayList<>(Arrays.asList(
        ...
        Map.of("id", "ORD-002", "customer", "Zayo Internal","amount",  890.50, "status", "pending"),
